...
export const de: Partial<Record<TranslationKey, string>> = {
  ...
  "print.opt.headingBreaks":       "Überschriften auf neuer Seite beginnen",
  "print.opt.headingBreaksDesc":   "Markdown-Ebenen, kommagetrennt — z. B. #,## für H1 und H2.",
  "print.opt.hrBreak":             "--- als Seitenumbruch behandeln",
  "print.opt.hrBreakDesc":         "Eine horizontale Linie (---) erzeugt einen Seitenumbruch statt einer Linie.",
